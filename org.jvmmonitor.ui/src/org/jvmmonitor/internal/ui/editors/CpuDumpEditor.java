...
import org.jvmmonitor.core.cpu.CpuModelFactory;
...
import org.jvmmonitor.internal.ui.properties.cpu.CallTreeContentProvider;
import org.jvmmonitor.internal.ui.properties.cpu.CallTreeFilteredTree;
import org.jvmmonitor.internal.ui.properties.cpu.CallTreeLabelProvider;
...
public class CpuDumpEditor extends AbstractDumpEditor implements
    ...
    private void createCallerViewer(Composite parent, int page) {
        final HotSpotsFilteredTree callerFilteredTree = new HotSpotsFilteredTree(
            ...
            protected String getMethodColumnName() {
                return org.jvmmonitor.internal.ui.properties.cpu.Messages.callerColumnLabel;
            }

            @Override
            protected String getMethodColumnToolTip() {
                return org.jvmmonitor.internal.ui.properties.cpu.Messages.callerColumnToolTip;
            }
        };
    ...
    private void createCalleeViewer(Composite parent, int page) {
        final HotSpotsFilteredTree calleeFilteredTree = new HotSpotsFilteredTree(
            ...
            @Override
            protected String getMethodColumnName() {
                return org.jvmmonitor.internal.ui.properties.cpu.Messages.calleeColumnLabel;
            }

            @Override
            protected String getMethodColumnToolTip() {
                return org.jvmmonitor.internal.ui.properties.cpu.Messages.calleeColumnToolTip;
            }
        };
