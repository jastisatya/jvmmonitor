 ...
 *******************************************************************************/
package org.jvmmonitor.internal.tools;

import static org.jvmmonitor.internal.tools.IConstants.BUNDLE_ROOT_PATH;
...
public class AgentLoadHandler implements IAgentLoadHandler {
    ...
    private void searchAgentJar() {
        URL entry = org.jvmmonitor.core.Activator.getDefault().getBundle()
